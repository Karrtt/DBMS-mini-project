...
<body style="background-color:#bdc3c7">
	<div id="main-wrapper">
	<center><h2 style="font-family:'Georgia';font-size:25px">Customer Registration </h2></center>
		<form action="customer.php" method="post">
			<div class="imgcontainer">
				<img src="imgs/customer.png" alt="Avatar" class="avatar">
			</div>
			<div class="inner_container">
				<label style="font-family:'Consolas';font-size:18px;font-weight: bold;text-decoration: underline;">Enter customer details (Enter customer id to perform delete)</label>
				<br><br>
				<label style="font-family:'Consolas';font-size:18px"><b>Customer Id</b></label>
				<input type="text" name="custid" placeholder="Enter 6 digits" required>
				...
				<label style="font-family:'Consolas';font-size:18px" ><b>Phone number</b></label>
				<input type="text" name="cphno" placeholder="Enter 10 digit phone number">
			...
			if(isset($_POST['register']))
			{
				...
				if(True)
				{
				    ...
				    if($query_run)
					{
						...
						{
							$query = "insert into customer values('$custid','$cname','$cphno','$cadd')";
			...
			if(isset($_POST['update']))
			{
				...
				if(True)
				{
				    ...
				    if($query_run)
					{
						if(mysqli_num_rows($query_run)>0)
						{
							$query = "update customer set Name ='$cname',Phone_no='$cphno',Address='$cadd' where Cust_ID ='$custid'";
                            
							$query_run = mysqli_query($con,$query);
							if($query_run)
							{
								echo '<script type="text/javascript">alert("Customer Updated.. Welcome")</script>';
